...
export const Features = () => {
    return (
        <>
            {/* How It Works */}
            <section id="methodology" className="section relative">
                <div className="w-full max-w-[1200px] mx-auto px-4 sm:px-6">
                    ...
                    >
                        ...
                        <p className="text-base sm:text-lg text-[rgb(var(--text-secondary))] max-w-2xl mx-auto">
                            A simple process designed to uncover your true career path
                        </p>
                    </motion.div>

                    {/* Mobile: Horizontal scroll for steps */}
                    <div className="sm:hidden swipe-container -mx-4 px-4 mb-8">
                        {steps.map((step, i) => (
                            <motion.div
                                key={step.number}
                                initial={{ opacity: 0, y: 20 }}
                                ...
                                className="swipe-item w-[75vw] max-w-xs card-glass p-6 text-center"
                            >
            ...
            <section className="py-12 sm:py-16 relative">
                <div className="w-full max-w-[1200px] mx-auto px-4 sm:px-6">
                    ...
                    <div className="sm:hidden swipe-container -mx-4 px-4">
                        {testimonials.map((testimonial, i) => (
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                transition={{ delay: i * 0.1 }}
                                className="swipe-item w-[85vw] max-w-sm card-glass p-5"
                            >
                                <p className="text-[rgb(var(--text-secondary))] mb-4 italic text-sm">
                                    "{testimonial.quote}"
                                </p>
                    ...
                    {/* Desktop: Grid */}
                    <div className="hidden sm:grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                        {testimonials.map((testimonial, i) => (
                            <motion.div
                                key={i}
                                initial={{ opacity: 0, y: 20 }}
            ...
            <section className="section relative overflow-hidden">
                ...
                <div className="w-full max-w-[1200px] mx-auto px-4 sm:px-6 relative">
                    ...
                    >
                        ...
                        <p className="text-base sm:text-lg text-[rgb(var(--text-secondary))] mb-8 sm:mb-10">
